 ...
 */
public class MultiplyAByBCommand implements Command {


  /**
   * Log instance.
   */
  private static Log log = LogFactory.getLog(MultiplyAByBCommand.class);
  ...
  public Result init(ChainContext chainContext) {
    ...
    log.info("\n\n**START**************************************");
    log.info("MultiplyAByBCommand init()");
  ...
  public Result execute(ChainContext chainContext) {
    ...
    log.info("MultiplyAByBCommand execute()...");
    ...
    chainContext.setAttribute("answer", c);
    log.info("a, b, answer == " + chainContext.getAttribute("a") + ", " +
      chainContext.getAttribute("b") + ", " +
      chainContext.getAttribute("answer"));
    log.info("MultiplyAByBCommand execute() done");
    return new Result(Result.SUCCESS);
  ...
  public Result cleanup(ChainContext chainContext) {
    ...
    log.info("MultiplyAByBCommand cleanup()");
    log.info("**END****************************************\n\n");
    return new Result(Result.SUCCESS);
