 ...
 */
public class ICaseTag extends BodyTagSupport {
   ...
   * Log instance.
   */
  private static Log log = LogFactory.getLog(ICaseTag.class);
  ...
  public int doAfterBody() throws JspException {
    ...
    StringBuffer sb = new StringBuffer(bcs.length());
