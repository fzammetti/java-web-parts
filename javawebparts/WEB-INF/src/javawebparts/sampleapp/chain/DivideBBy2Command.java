 ...
 */
public class DivideBBy2Command implements Command {


  /**
   * Log instance.
   */
  private static Log log = LogFactory.getLog(DivideBBy2Command.class);
  ...
  public Result init(ChainContext chainContext) {
    ...
    log.info("\n\n**START**************************************");
    log.info("DivideBBy2Command init()");
  ...
  public Result execute(ChainContext chainContext) {
    ...
    log.info("DivideBBy2Command execute()...");
    ...
    log.info("a, b, answer == " + chainContext.getAttribute("a") + ", " +
      chainContext.getAttribute("b") + ", " +
      chainContext.getAttribute("answer"));
    log.info("DivideBBy2Command execute() done");
    return new Result(Result.SUCCESS);
  ...
  public Result cleanup(ChainContext chainContext) {
    ...
    log.info("DivideBBy2Command cleanup()");
    log.info("**END****************************************\n\n");
    return new Result(Result.SUCCESS);
