 ...
 */
public class Subtract2FromBCommand implements Command {


  /**
   * Log instance.
   */
  private static Log log = LogFactory.getLog(Subtract2FromBCommand.class);
  ...
  public Result init(ChainContext chainContext) {
    ...
    log.info("\n\n**START**************************************");
    log.info("Subtract2FromBCommand init()");
  ...
  public Result execute(ChainContext chainContext) {
    ...
    log.info("Subtract2FromBCommand execute()...");
    ...
    log.info("a, b, answer == " + chainContext.getAttribute("a") + ", " +
      chainContext.getAttribute("b") + ", " +
      chainContext.getAttribute("answer"));
    log.info("Subtract2FromBCommand execute() done");
    return new Result(Result.SUCCESS);
  ...
  public Result cleanup(ChainContext chainContext) {
    ...
    log.info("Subtract2FromBCommand cleanup()");
    log.info("**END****************************************\n\n");
    return new Result(Result.SUCCESS);
