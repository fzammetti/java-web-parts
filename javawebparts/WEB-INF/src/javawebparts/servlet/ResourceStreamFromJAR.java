 ...
 * serve resources from a JAR file in the classpath.  Note that this
...
public class ResourceStreamFromJAR implements ResourceStream {
  ...
  static {
    try {
      ...
      System.err.println("ResourceStreamFromJAR" +
   ...
   * Log instance.
   */
  private static Log log = LogFactory.getLog(ResourceStreamFromJAR.class);
  ...
  public InputStream getStream(String inRequestedResource, String inParam1,
    ...
    InputStream is = loader.getResourceAsStream(inRequestedResource);
    if (is == null) {
