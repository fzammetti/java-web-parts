...
/**
 * This filter allows for setting cache control headers on requests to a
 * webapp.  It allows for including or excluding paths from filter
 * functionality.
 * <br><br>
 * Init parameters are:
 * <br>
 ...
 * <br><br>
 * &lt;filter&gt;<br>
 * &nbsp;&nbsp;&lt;filter-name&gt;CacheControlFilter&lt;/filter-name&gt;<br>
 * &nbsp;&nbsp;&lt;filter-class&gt;javawebparts.filter.
 * CacheControlFilter&lt;/filter-class&gt;<br>
 * &nbsp;&nbsp;&lt;init-param&gt;<br>
...
public class CacheControlFilter implements Filter {
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    if (FilterHelpers.filterPath(request, pathList, pathSpec)) {
      log.info("CacheControlFilter firing...");
      log.info("Adding cache headers to response for path = " + path);
