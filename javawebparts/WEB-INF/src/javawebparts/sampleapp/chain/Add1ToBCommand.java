 ...
 */
public class Add1ToBCommand implements Command {


  /**
   * Log instance.
   */
  private static Log log = LogFactory.getLog(Add1ToBCommand.class);
  ...
  public Result execute(ChainContext chainContext) {
    ...
    log.info("Add1ToBCommand execute()...");
    ...
    log.info("a, b, answer == " + chainContext.getAttribute("a") + ", " +
      chainContext.getAttribute("b") + ", " +
      chainContext.getAttribute("answer"));
    log.info("Add1ToBCommand execute() done");
    return new Result(Result.SUCCESS);
  ...
  public Result cleanup(ChainContext chainContext) {
    ...
    log.info("Add1ToBCommand cleanup()");
    log.info("**END****************************************\n\n");
    return new Result(Result.SUCCESS);
