 ...
 */
public class AddAToBCommand implements Command {


  /**
   * Log instance.
   */
  private static Log log = LogFactory.getLog(AddAToBCommand.class);
  ...
  public Result execute(ChainContext chainContext) {
    ...
    log.info("AddAToBCommand execute()...");
    ...
    log.info("a, b, answer == " + chainContext.getAttribute("a") + ", " +
      chainContext.getAttribute("b") + ", " +
      chainContext.getAttribute("answer"));
    log.info("AddAToBCommand execute() done");
    return new Result(Result.SUCCESS);
  ...
  public Result cleanup(ChainContext chainContext) {
    ...
    log.info("AddAToBCommand cleanup()");
    log.info("**END****************************************\n\n");
    return new Result(Result.SUCCESS);
