 ...
 * <br><br>
 * &lt;filter&gt;<br>
 * &nbsp;&nbsp;&lt;filter-name&gt;SessionInactivityFilter&lt;
 * /filter-name&gt;<br>
 ...
 * with modifications by Tamas Szabo.
 */
public class SessionInactivityFilter implements Filter {
  ...
  static {
    try {
      ...
      System.err.println("SessionInactivityFilter" +
   ...
   * Log instance.
   */
  private static Log log = LogFactory.getLog(SessionInactivityFilter.class);
  ...
  public void doFilter(ServletRequest request, ServletResponse response,
    ...
    if (FilterHelpers.filterPath(request, pathList, pathSpec)) {
      ...
      // If the client wants to join a session (i.e., it has a session ID)
      // but that session ID is not valid anymore we have to redirect or forward
      if (req.getRequestedSessionId() != null &&
         !req.isRequestedSessionIdValid()) {
        log.info("Session requested by client doesn't exist anymore");
