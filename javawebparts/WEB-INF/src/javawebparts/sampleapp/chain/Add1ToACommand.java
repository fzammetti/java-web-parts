 ...
 */
public class Add1ToACommand implements Command {


  /**
   * Log instance.
   */
  private static Log log = LogFactory.getLog(Add1ToACommand.class);
  ...
  public Result execute(ChainContext chainContext) {
    ...
    log.info("Add1ToACommand execute()...");
    ...
    log.info("a, b, answer == " + chainContext.getAttribute("a") + ", " +
      chainContext.getAttribute("b") + ", " +
      chainContext.getAttribute("answer"));
    log.info("Add1ToACommand execute() done");
    return new Result(Result.SUCCESS);
  ...
  public Result cleanup(ChainContext chainContext) {
    ...
    log.info("Add1ToACommand cleanup()");
    log.info("**END****************************************\n\n");
    return new Result(Result.SUCCESS);
