 ...
 */
public class EntityEncodeTag extends BodyTagSupport {
  ...
  static {
    try {
      ...
      System.err.println("EntityEncodeTag" +
   ...
   * Log instance.
   */
  private static Log log = LogFactory.getLog(EntityEncodeTag.class);
  ...
  public int doAfterBody() throws JspException {
    ...
    text = JWPHelpers.encodeEntities(bcs, null);
    return SKIP_BODY;
